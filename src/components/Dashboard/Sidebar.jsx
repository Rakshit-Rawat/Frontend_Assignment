...
export default function Sidebar({ tab, setTab }) {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        <motion.aside
          className={`fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 shadow-2xl md:flex md:flex-col border-r border-gray-700 z-40`}
          initial="closed"
              ...
              >
                <img
                  ...
                  className={`w-6 h-6 mr-3 transition-opacity ${
                    tab === key ? "filter brightness-0 invert" : "opacity-80 group-hover:opacity-100"
                  }`}
                />
                {label}
              </motion.button>
